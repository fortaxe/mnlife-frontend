...
const Sidebar = () => {
  ...
  return (
    <div className="flex">
      ...
      <aside
        id="default-sidebar"
        className={`fixed top-0 left-0 z-40 w-[200px] h-screen bg-white transition-transform ${
      ...
      >
        <div className="h-full overflow-y-auto bg-white">
          ...
          <ul className="font-medium">
            ...
            <li className="mt-3">
              <Link
                to="/admin/dashboard/today-appointments"
                className={`flex items-center text-white p-2 ${
                  isActiveRoute("/admin/dashboard/today-appointments")
                    ? "bg-[#386D62]"
                    : "bg-[#CCA66B] hover:bg-[#386D62]"
                }`}
              >
                <span className="ms-3">Today's Appointments</span>
              </Link>
            </li>
            <li className="mt-3">
              <Link

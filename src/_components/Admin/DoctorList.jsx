...
import { fetchClinics, deleteClinic } from "@/redux/doctorList";
                        ...
                        {filteredClinics.map((clinic, index) => (
                            <tr className="odd:bg-gray-50" key={index} style={{ height: "80px" }}>
                                ...
                                <td className="whitespace-nowrap px-4 py-2 text-gray-700">
                                    ...
                                    <button className="block p-1 px-4 rounded-md mt-2 text-sm bg-[#FFD9BD]" onClick={() => handleDeleteClinic(clinic._id)}>
                                        Archive
                                    </button>
                                </td>
